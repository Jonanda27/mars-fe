      ...
      <div className="p-6 max-w-[1400px] mx-auto flex flex-col gap-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
          ...
          <div className="bg-white p-4 shadow-sm flex items-center gap-4">
            ...
            <div>
              <p className="text-[11px] text-[#999] font-bold uppercase">Transaksi Parkir Hari Ini</p>
              <p className="text-[20px] font-bold text-[#333] font-mono">1.258</p>
              <p className="text-[10px] text-[#999]">Kendaraan masuk</p>
            </div>
          </div>

          <div className="bg-white p-4 shadow-sm flex items-center gap-4">
            <div className="w-12 h-12 bg-[#3c8dbc]/10 flex items-center justify-center flex-shrink-0">
              <DollarSign className="w-6 h-6 text-[#3c8dbc]" />
            </div>
            <div>
              <p className="text-[11px] text-[#999] font-bold uppercase">Pendapatan Parkir Hari Ini</p>
              <p className="text-[20px] font-bold text-[#333] font-mono">Rp 8,4 Jt</p>
              <p className="text-[10px] text-[#999]">Roda 2 + Roda 4</p>
            </div>
          </div>
        </div>
